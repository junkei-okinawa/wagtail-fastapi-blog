from .base import SECRET_KEY, INSTALLED_APPS, MIDDLEWARE, TEMPLATES, LANGUAGE_CODE, TIME_ZONE, USE_I18N, USE_TZ, DEFAULT_AUTO_FIELD, WAGTAIL_SITE_NAME, ROOT_URLCONF, WSGI_APPLICATION, AUTH_PASSWORD_VALIDATORS # 必要な設定を明示的にインポート
...
CSRF_TRUSTED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:8000,http://127.0.0.1:8000').split(',')
